...
#define m8s_concats(a,b) (m8s_concat((a),(b),strlen(b)),(a)->s=(a)->s)
#define m8s_concat8s(dest,src)(m8s_concat((dest),(src)->s,(src)->n),(dest)->s=(dest)->s)
#define m8s_concatcm(a,b) ( (b)==0?(a)->s:((a)->n+1<(a)->sz)? ((a)->s[(a)->n++]=(b),(a)->s[(a)->n]='\0',(a)->s):m8s_concatc(a,b))
#define m8s_reset(a) ((a)->n=0,(a)->s[0]='\0',(a)->s=(a)->s)
...
#define mU16s_concats(a,b) (mU16s_concat((a),(b),wcslen(b)),(a)->s=(a)->s)
#define mU16s_concatU16s(a,b)(mU16s_concat((a),(b)->s,(b)->n),(a)->s)
#define mU16s_concatcm(a,b) ((b)==0?(a)->s:((a)->n +1 < (a)->sz)? ((a)->s[(a)->n++]=(b),(a)->s[(a)->n]='\0',(a)->s):mU16s_concatc(a,b))
#define mU16s_reset(a) ((a)->n=0,(a)->s[0]='\0',(a)->s=(a)->s)
